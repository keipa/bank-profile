...
using BankProfiles.Web.Application.Features.MetricCharts.Services;
using BankProfiles.Web.Application.Features.Metrics.Services;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddBankProfileServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IMetricChartService, MetricChartService>();
        services.AddScoped<IMetricInteractionService, MetricInteractionService>();
        services.AddScoped<HistoricalDataSeeder>();
        services.AddScoped<MetricEventHistoricalSeeder>();
