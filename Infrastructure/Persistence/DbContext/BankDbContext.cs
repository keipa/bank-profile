...
namespace BankProfiles.Web.Infrastructure.Persistence.DbContext;

public class BankDbContext(DbContextOptions<BankDbContext> options) : Microsoft.EntityFrameworkCore.DbContext(options)
{
